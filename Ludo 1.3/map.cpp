...
void map() {
	...
	grayBackground(color);
	if(podium[0]!="0")cout << "\t FIRST PLACE:";
	// ...LEFT AND RIGHT WING... ---------------------------------------------------------------------------------------------------------    ...LEFT AND RIGHT WING...
	cout << endl << "    |---|---|---|---|---|---|---|---|---|---|---|";
	// DICE -----------------------------------------------------------------------------------------------------------         DICE
	cout << "\t\t";
	...
	grayBackground(color);
	if (podium[1] != "0")cout << "\t SECOND PLACE:";
	// ...LEFT AND RIGHT WING... ---------------------------------------------------------------------------------------------------------    ...LEFT AND RIGHT WING...
	cout << endl << "    |";
	...
	grayBackground(color);
	if (podium[2] != "0")cout << "\t THIRD PLACE:";
	// ...LEFT AND RIGHT WING ---------------------------------------------------------------------------------------------------------    ...LEFT AND RIGHT WING
	cout << endl << "    |---|---|---|---|---|---|---|---|---|---|---|" << endl << "    |";
	...
	for (int i = 0; i <= 3; i++)
	{
		if ((((!((player->pawns[i])->inFinal) && (((player->pawns[i])->position + x) > player->meta && ((player->pawns[i])->position <= player->meta) && (((player->pawns[i])->position) >= ((player->meta) - 5)))) || ((player->pawns[i])->inFinal))
			...
			|| (!((player->pawns[i])->inFinal) && (!((player->pawns[i])->inBase))
				...
				&& (fields[(((player->pawns[i])->position) + x)]) != '8')|| ((player->pawns[i])->inFinal)&&(((player->pawns[i])->position)+x)<=4)
...
void turn(Player* player)
{
	...
	{
		header(player);
		if ((player->inBase == 3 && player->inEnded == 1) || (player->inBase == 2 && player->inEnded == 2) || (player->inBase == 1 && player->inEnded == 3))
			y = 1;
		else {
			cout << "leave base (1) \nmove pawn (2)";
			cin >> y;
